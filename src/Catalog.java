...
// Todo
// catalog, мы делаем каталог для магазина, id будет в формате int, 2 Title в формате String;
...
// TODO - Этап 4
// 1 шаг Полиморфизм. добавить полиморфизм в Product. добавить в Category Show_Info. создать несколько разных товаров в
// Product. через Show_Info показывать весь список товаров
//